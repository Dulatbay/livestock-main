...
## Database diagram
Use [LiveStock.drawio.png](LiveStock.drawio.png) for view database diagram

## Application
Use [Техническое задание СЖК.docx](Техническое-задание-СЖК.docx) for view application overview
